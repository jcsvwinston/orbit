...
| --- | --- | --- | --- | --- | --- |
| `v1.8.25` | `v0.4.4` | `v0.6.14` | `v0.10.17` | `v1.8.19` | `v1.8.19` |
| `v1.8.24` | `v0.4.4` | `v0.6.14` | `v0.10.17` | `v1.8.19` | `v1.8.18` |
| `v1.8.23` | `v0.4.4` | `v0.6.14` | `v0.10.16` | `v1.8.19` | `v1.8.18` |
| `v1.8.22` | `v0.4.4` | `v0.6.13` | `v0.10.15` | `v1.8.19` | `v1.8.18` |
| `v1.8.21` | `v0.4.3` | `v0.6.12` | `v0.10.14` | `v1.8.18` | `v1.8.18` |
| `v1.8.20` | `v0.4.3` | `v0.6.12` | `v0.10.14` | `v1.8.18` | `v1.8.18` |
| `v1.8.19` | `v0.4.3` | `v0.6.12` | `v0.10.13` | `v1.8.18` | `v1.8.18` |
| `v1.8.18` | `v0.4.3` | `v0.6.11` | `v0.10.12` | `v1.8.18` | `v1.8.18` |
| `v1.8.17` | `v0.4.2` | `v0.6.10` | `v0.10.11` | `v1.8.17` | `v1.8.17` |
| `v1.8.16` | `v0.4.2` | `v0.6.10` | `v0.10.11` | `v0.4.10` | `v0.2.19` |
| `v1.8.15` | `v0.4.2` | `v0.6.10` | `v0.10.10` | `v0.4.10` | `v0.2.19` |
| `v1.8.14` | `v0.4.2` | `v0.6.9` | `v0.10.9` | `v0.4.9` | `v0.2.18` |
| `v1.8.13` | `v0.4.2` | `v0.6.8` | `v0.10.8` | `v0.4.8` | `v0.2.17` |
| `v1.8.12` | `v0.4.2` | `v0.6.8` | `v0.10.8` | `v0.4.8` | `v0.2.17` |
| `v1.8.11` | `v0.4.2` | `v0.6.7` | `v0.10.7` | `v0.4.7` | `v0.2.16` |
