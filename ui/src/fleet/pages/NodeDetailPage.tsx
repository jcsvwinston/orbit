...
import { PageBody } from '@/fleet/components/Page'
import { Card, Chip, Dot, Label } from '@/fleet/components/ui'
import { SEMANTIC, methodColor, sqlKindColor, statusColor } from '@/fleet/lib/colors'
import { t } from '@/fleet/lib/i18n'
import { formatRelative, formatTime, streamRowKey, timestampToDate } from '@/fleet/lib/format'
import { NodeStatusPill } from '@/fleet/pages/NodesPage'
import { HostMetricCards } from '@/fleet/pages/MetricsPage'
