...
import { Card, Chip, Dot, Label, Progress, Segmented } from '@/fleet/components/ui'
import { SEMANTIC } from '@/fleet/lib/colors'
import { t } from '@/fleet/lib/i18n'
import { useNodes } from '@/fleet/hooks/useNodes'
import { useFleetStats, formatRate } from '@/fleet/hooks/useFleetStats'
import { useHostMetricSeries, type HostMetricSeries } from '@/fleet/hooks/useHostMetricSeries'
import { timestampToDate } from '@/fleet/lib/format'
import type { HostMetrics } from '@/fleet/gen/nucleus/admin/v1/admin_pb'
