...
import { Sparkline } from '@/fleet/components/Sparkline'
import { Card, Dot, Label, Pill } from '@/fleet/components/ui'
import { SEMANTIC, methodColor, sqlKindColor, statusColor } from '@/fleet/lib/colors'
...
import type { Event, NodeInfo } from '@/fleet/gen/nucleus/admin/v1/admin_pb'
import {
  durationToMillis,
  formatDuration,
  formatRelative,
