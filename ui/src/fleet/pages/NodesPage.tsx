...
import type { NodeInfo } from '@/fleet/gen/nucleus/admin/v1/admin_pb'
import { fleetMainVersion } from '@/fleet/lib/fleet'
import { useNodes } from '@/fleet/hooks/useNodes'
import { PageBody, PageHeader } from '@/fleet/components/Page'
import { Chip, Dot, GhostButton } from '@/fleet/components/ui'
import { SEMANTIC } from '@/fleet/lib/colors'
import { t } from '@/fleet/lib/i18n'
import { formatRelative, timestampToDate } from '@/fleet/lib/format'
