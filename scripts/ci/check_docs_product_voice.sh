...
#
# The website is the product's shop window. A reader evaluating Orbit does not
...
\b(OR|QK|NU|QM)[0-9]+-[0-9]+\b	Internal audit finding ID — describe the change instead.
EOF
)
